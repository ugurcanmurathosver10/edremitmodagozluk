    ...
    <div class="container mx-auto px-6 md:px-12 max-w-[90rem]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-4">
                    <a href="https://instagram.com/{{ $siteSettings['instagram'] ?? 'edremitmoda' }}" target="_blank" class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:border-amber-500 hover:text-amber-500 transition-all">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-gray-500 text-xs font-bold uppercase tracking-widest leading-relaxed">
                        <svg class="w-4 h-4 text-amber-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path></svg>
                        <span>{{ $siteSettings['address'] ?? 'Edremit / Balıkesir' }}</span>
                    </li>
                    <li>
                        <a href="https://wa.me/{{ $siteSettings['whatsapp'] ?? '905448995965' }}" class="flex items-center gap-3 text-gray-500 hover:text-amber-500 transition-colors text-xs font-bold uppercase tracking-widest">
                    ...
                    <li class="flex items-center gap-3 text-gray-500 text-xs font-bold uppercase tracking-widest">
                        <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        {{ $siteSettings['email'] }}
                    </li>
                    @endif
                </ul>
        ...
        <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-2 text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em]">
                ...
                <a href="https://ugurcanmurathosver.com.tr" target="_blank" class="group flex items-center gap-1.5 text-white hover:text-amber-500 transition-all duration-300">
